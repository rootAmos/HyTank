...
# Extension modules
# ==============================================================================
from lngtank.utilities import ElementMultiplyDivideComp
...
class HeatTransferVacuumTank(om.Group):
    ...
    gaseous or LNG temperature. This is a reasonably good assumption
    ...
    T_liq : float
        Temperature of the LNG (vector, K)
    T_gas : float
        Temperature of the gaseous natural gas (vector, K)
    A_wet : float
